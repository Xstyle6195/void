...
export const BUILDINGS: Record<string, BuildingType> = {
  ...
  school: {
    ...
    effects: { populationGrowth: 0.01, gold: 3, research: 2 },
  },
  laboratory: {
    id: "laboratory",
    name: "Laboratoire",
    ...
    effects: { gold: 9, prestige: 3, research: 5 },
  },
  observatory: {
    id: "observatory",
    name: "Observatoire",
    ...
    effects: { prestige: 4, stability: 1, research: 3 },
  },
  universite: {
    id: "universite",
    name: "Université",
    category: "scientific",
    requiresTech: "steam_academia",
    cost: 220,
    description: "Forme les esprits qui feront entrer Orion dans une ère nouvelle.",
    effects: { populationGrowth: 0.015, gold: 6, research: 8 },
  },
  centre_recherche: {
    id: "centre_recherche",
    name: "Centre de recherche",
    category: "scientific",
    requiresTech: "modern_governance",
    cost: 300,
    description: "Accélère considérablement le progrès technologique du royaume.",
    effects: { gold: 10, prestige: 5, research: 14 },
  },
  centre_spatial: {
    id: "centre_spatial",
    name: "Centre spatial",
    category: "scientific",
    requiresTech: "future_institutions",
    cost: 380,
    description: "Étudie les étoiles et prépare la conquête d'Orion tout entier.",
    effects: { prestige: 12, gold: 10, research: 18 },
  },
